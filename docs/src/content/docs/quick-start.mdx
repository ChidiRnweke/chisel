...
<Tabs>
  ...
  <TabItem label="TypeScript (SvelteKit)">
    ...
    chisel-js init ./your-frontend      # once: detects the topology
...
<Tabs>
  ...
  <TabItem label="TypeScript">
    ```bash
    chisel-js init ./your-frontend         # once, before the first check
    chisel-js check ./your-frontend
    ```

    `init` works out whether the project is a standalone SSR app (Drizzle
